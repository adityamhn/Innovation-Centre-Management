...
import { getAllWorkspaceRequests } from "@/services/admin.services";
...
const WorkspaceRequests = () => {
  ...
  const { data, isLoading } = useQuery("all-requests", getAllWorkspaceRequests);
  ...
  return (
    <div className={styles.adminDashboardContainer}>
      <div className={styles.dashboardHeader}>
        <h1 className={styles.heading}>Workspace Requests</h1>
      </div>
      <Row
        align="middle"
      ...
      <div className={styles.dashboardTableContainer}>
        <WorkspaceRequestsTable data={data.requests} setRequestModal={setRequestModal} />
      </div>
